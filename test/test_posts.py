...
@pytest.mark.anyio  # this decorator let pytest to know how to handle async function 
...
async def test_get_posts_with_pagination(client: AsyncClient):
    ...
    assert data["has_more"] is False  # because we already get all the posts here
