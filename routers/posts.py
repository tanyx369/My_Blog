...
from app.schemas import PostCreate, PostResponse, PostUpdate, PaginatedPostsResponse
...
async def update_post_full(
    ...
    # No need check the user exits or not 
    ...
    # post.user_id = post_data.user_id # no need as only the owner can update it and we can't change owner here
...
async def create_post(post: PostCreate, current_user:CurrentUser, db: Annotated[AsyncSession, Depends(get_db)]):
    ...
    # After using token to get current user, we no need to check the user id anymore  
