...
from app.image_utils import delete_profile_image, process_profile_image, upload_profile_image
...
async def upload_profile_picture(
    ...
    try:
        processed_bytes, new_filename = await run_in_threadpool(process_profile_image, content) # To prevent conflict between async process and CPUBound Task
